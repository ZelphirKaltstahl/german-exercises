...
Antworten auf die folgenden Fragewörter erfordern den Nominativ: <!-- TODO translate -->
...
(keine)<!-- TODO translate -->

## Genetive case

### Question words

Antworten auf die folgenden Fragewörter erfordern den Genitiv:<!-- TODO translate -->

* Wessen<!-- TODO translate -->
* Weswegen<!-- TODO translate -->
...
Antworten auf die folgenden Fragewörter erfordern den Dativ:<!-- TODO translate -->

* Wem<!-- TODO translate -->
* Womit<!-- TODO translate -->
...
Antworten auf die folgenden Fragewörter erfordern den Akkusativ:<!-- TODO translate -->
...
Es gibt jedoch auch Sätze in denen beide Varianten verwendet werden können:<!-- TODO translate -->

* Ich kenne den Weg(, weil ich ihn schon viele Male gegangen bin). (häufiger)<!-- TODO translate -->
* Ich weiß den Weg. (Ich habe Informationen darüber, wie wir zum Ziel kommen.) (seltener)<!-- TODO translate -->

## Examples

1. Ich _kenne_ ihn. (Erklärung: _Person_)<!-- TODO translate -->
2. Ich _kenne_ China. (Erklärung: _Ort_)<!-- TODO translate -->
3. _Kennst_ du den neuen Film schon? (Erklärung: _to be familiar with_ / _K4_)<!-- TODO translate -->
4. Er _kennt_ den Geschmack. (Erklärung: _sinnliche Erfahrung_)<!-- TODO translate -->
5. _Kennst_ du den Unterschied zwischen 'schwer' und 'schwierig'? Ich kenne den _Unterschied_. (Erklärung: _K4_)<!-- TODO translate -->
6. Sie _weiß_, wie spät es ist. (Erklärung: _Informationen haben_, _W3_)<!-- TODO translate -->
7. Du _weißt_, wann ich nach Deutschland gezogen bin. (Erklärung: _to know a fact_, _W3_)<!-- TODO translate -->
8. Ich _weiß_, wann der Zug kommt. (Erklärung: _W3_)<!-- TODO translate -->
...
* _Wie_ wird verwendet, wenn man eine Gemeinsamkeit von Objekten hervorheben möchte. Das bedeutet, dass in Vergleichen mit _als_ der Positiv verwendet wird.<!-- TODO translate -->
* _Als_ wird verwendet, wenn man einen Unterschied von Objekten hervorheben möchte. Das bedeutet, dass in Vergleichen mit _als_ der Komparativ verwendet wird.<!-- TODO translate -->

## Exercise

1. Im Sommer ist es länger hell _als_ im Winter. <!-- TODO translate -->
2. Das Essen ist so scharf _wie_ in China. <!-- TODO translate -->
3. Es gibt wenige so trübe Tage _wie_ diesen im Jahr. <!-- TODO translate -->
4. Uns geht es so gut _wie_ immer. <!-- TODO translate -->
5. Hier ist die Auswahl größer _als_ in der kleinen Buchhandlung. <!-- TODO translate -->
6. Er kann schneller rennen _als_ ich. <!-- TODO translate -->
7. Ihr Wortschatz ist viel größer _als_ meiner. <!-- TODO translate -->
8. Heute ist schöneres Wetter _als_ gestern. <!-- TODO translate -->
9. Die Datenmenge ist so groß _wie_ noch nie zuvor. <!-- TODO translate -->
10.
11.
12.
13.
...
10. Mein Standpunkt ist, dass ..... . <!-- TODO -->
11. Ich vertrete den Standpunkt, dass ..... . <!-- TODO -->
12. Meiner Einschätzung nach ..... . <!-- TODO -->
13. Ich finde ..... . <!-- TODO -->
14. Ich erachte ..... als ..... . <!-- TODO -->
