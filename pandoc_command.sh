...
deutsch-uebungen-de.md \
-o deutsch-uebungen-de.pdf

if [ $? -eq 0 ]; then
	echo -e "${SUCCESS_COLOR}Successfully${NO_COLOR} compiled ${HIGHLIGHT_COLOR}deutsch-uebungen-de.pdf${NO_COLOR}"
else
	echo -e "${ERROR_COLOR}Failed${NO_COLOR} to create ${HIGHLIGHT_COLOR}deutsch-uebungen-de.pdf${NO_COLOR}"
	exit 1
fi
...
--chapters \
--standalone \
--template=template-book-zh.latex \
--latex-engine=xelatex \
deutsch-uebungen-zh.md \
-o deutsch-uebungen-zh.pdf

if [ $? -eq 0 ]; then
	echo -e "${SUCCESS_COLOR}Successfully${NO_COLOR} compiled ${HIGHLIGHT_COLOR}deutsch-uebungen-zh.pdf${NO_COLOR}"
else
	echo -e "${ERROR_COLOR}Failed${NO_COLOR} to create ${HIGHLIGHT_COLOR}deutsch-uebungen-zh.pdf${NO_COLOR}"
	exit 1
fi
